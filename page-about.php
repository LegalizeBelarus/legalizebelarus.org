...
<div class="container bg-light px-0 pb-4 pt-4 cont">
    <div class="jumbotron d-flex flex-column jumbotron-fluid justify-content-center align-items-center px-3 text-center"
        ...
        <p class="display-4 text-light text-shadow mt-3">We are Legalize Belarus</p>
    ...
    <main role="main">
        <section>
            ...
            <div class="container pb-5">
                <p>Legalize Belarus pursues a change in public attitude towards people who use drugs.
                </p>
                ...
                <p>We contend that the state should exclude possession of small amounts of controlled drugs
                    from the criminal code, develop a meaningful and effective harm reduction policy, and make drugs
                    that are capable of treating clinical conditions available to those in need.
                </p>

                <p>We are trying to materialise our vision by means of civic education, public advocacy and
                    supporting the convicted.
                </p>
            </div>

            <div class="container pb-5 text-center">
                <p class="display-4">Strategy</p>
            </div>
            ...
            <div class="container pb-5">
                ...
                <div class="row h-100 mb-3">
                    ...
                    <div class="col-md-10 my-auto text-center text-md-left">
                        <h5>Deliver education about psychoactive substances and addictions</h5>
                        <p>Promote human rights, civil liberties, and evidence-based approach to drug regulation.
                            <br>Inform about harm reduction practices.</p>
                    </div>
                ...
                <div class="row h-100">
                    ...
                    <div class="col-md-10 my-auto text-center text-md-left">
                        <h5>Support drug users and people convicted under Article 328</h5>
                        <p>Organize a community of legal and psychological support for those in drug-related predicament
                            and their relatives.
                            <br>Drug checking.</p>
                    </div>
            ...
            <div class="container pb-4 text-center">
                <p class="display-4">Legalize Belarus in media</p>
            </div>

            <div class="container text-center pb-3">
                <p>More than 500 mentions in local, national and international media</p>
            </div>
            ...
            <div class="row pb-5 justify-content-center">
                    ...
                    <a target="_blank" class="no-dec text-dark" href="https://facebook.com/stas.shashok">
                        <div class="card">
                            ...
                            <div class="card-body rad-b">
                                <h5 class="card-title">Stas Shashok</h5>
                                <p class="card-text font-weight-normal">Head of Communications</p>
                            </div>
                        </div>
                    </a>
                </div>
                ...
                <div class="col-6 col-md-4 col-lg-3 mb-3">
                    <a target="_blank" class="no-dec text-dark" href="https://facebook.com/KonnikPahoni">
                        <div class="card">
                            ...
                            <div class="card-body rad-b">
                                <h5 class="card-title">Piotr Markielau</h5>
                                <p class="card-text font-weight-normal">International Secretary</p>
                            </div>
                        </div>
                    </a>
                </div>
                    ...
                    <a target="_blank" class="no-dec text-dark" href="https://facebook.com/ksusha.tarasevich">
                        <div class="card">
                            <img src="<?php bloginfo( 'template_url' ); ?>/images/team/Ksenija.jpg"
                                 class="card-img-top">
                            <div class="card-body rad-b">
                                <h5 class="card-title">Kseniya Tarasevich</h5>
                                <p class="card-text font-weight-normal">Founder</p>
                            </div>
                        </div>
                    </a>
                ...
                <div class="col-6 col-md-4 col-lg-3 mb-3">
                    <a target="_blank" class="no-dec text-dark" href="https://facebook.com/yan.yakimovich">
                        <div class="card">
                            ...
                            <div class="card-body rad-b">
                                <h5 class="card-title">Yan Yakimovich</h5>
                                <p class="card-text font-weight-normal">Media team</p>
                            </div>
                        </div>
                    </a>
                ...
                <div class="col-6 col-md-4 col-lg-3 mb-3">
                    <a target="_blank" class="no-dec text-dark" href="https://www.facebook.com/babakushwisdom">
                        <div class="card">
                            <img src="<?php bloginfo( 'template_url' ); ?>/images/team/BabaKush.jpg"
                                 class="card-img-top">
                            <div class="card-body rad-b">
