<?php /* Template Name: page-newsletter */ ?>
...
<div class="container bg-light px-0 pt-4 mb-0 cont">
    <div class="jumbotron d-flex pb-0 mb-0 flex-column jumbotron-fluid justify-content-center align-items-center px-3 text-center"
        ...
        <p class="display-4 text-light text-shadow">Ты в клубе! Поздравляем! 🐇</p>
...
<div class="container cont bg-light pb-5 px-md-5">
            ...
            <div class="container text-center">
                <p class="lead pt-5">Скоро ты получишь сообщение о добавлении в закрытую Google-группу. Чтобы получать более
