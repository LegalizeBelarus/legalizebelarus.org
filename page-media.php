...
<div class="container bg-light pb-5 pt-4 px-md-5 cont">
    ...
    <div class="row pb-5">
        <div class="col text-center">
            <p class="display-4 mb-4">Media mentions</p>
            <a href="/news"><div class="badge-primary badge shadow my-1">All news</div></a>
            <a href="/press"><div class="badge-primary badge shadow my-1">Press Service</div></a>
        ...
        <div class="row mb-4 post-container mx-3">
            ...
            <div class="col-lg-3 px-0">
                <div class="h-100 rad-l news_wrapper">
                    ...
                    <div class="img_holder" style="background-image: linear-gradient(rgba(0,0,0,0),rgba(0,0,0,0.7)),
            ...
            <div class="col-lg-9 px-0">
                <div class="container d-flex flex-column h-100 w-100">
                    <div>
                        <h4 ><?php the_title(); ?></h4>
                        <p class="font-weight-normal"><?php if ( ! has_excerpt() ) { echo '';} else { echo get_the_excerpt();} ?></p>
                    </div>
